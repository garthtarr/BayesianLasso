...
// [[Rcpp::export]]
List lasso_gibbs_Bc(arma::mat mX, arma::vec vy, double a, double b, double u, double v, 
                     ...
                     int verbose)
{
  ...
  for (int i = 0; i < maxiter; ++i) 
  {
    ...
    lambda2 = lambda2; //slice_sampler_precision_c(lambda2, a_val, b_val, c_val);
    lambda  = sqrt(lambda2);
