...
// Modified_Hans_Gibbs
Rcpp::List Modified_Hans_Gibbs(const arma::mat& X, const arma::vec& y, const arma::vec& beta_init, double a1, double b1, double u1, double v1, int nsamples, double lambda_init, double sigma2_init, int thin, int verbose, bool tune_lambda2, bool rao_blackwellization);
RcppExport SEXP _BayesianLasso_Modified_Hans_Gibbs(SEXP XSEXP, SEXP ySEXP, SEXP beta_initSEXP, SEXP a1SEXP, SEXP b1SEXP, SEXP u1SEXP, SEXP v1SEXP, SEXP nsamplesSEXP, SEXP lambda_initSEXP, SEXP sigma2_initSEXP, SEXP thinSEXP, SEXP verboseSEXP, SEXP tune_lambda2SEXP, SEXP rao_blackwellizationSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Modified_Hans_Gibbs(X, y, beta_init, a1, b1, u1, v1, nsamples, lambda_init, sigma2_init, thin, verbose, tune_lambda2, rao_blackwellization));
    return rcpp_result_gen;
END_RCPP
}
// Modified_PC_Gibbs
List Modified_PC_Gibbs(const arma::mat X, const arma::vec y, double a1, double b1, double u1, double v1, int nsamples, double lambda_init, double sigma2_init, int thin, int verbose);
RcppExport SEXP _BayesianLasso_Modified_PC_Gibbs(SEXP XSEXP, SEXP ySEXP, SEXP a1SEXP, SEXP b1SEXP, SEXP u1SEXP, SEXP v1SEXP, SEXP nsamplesSEXP, SEXP lambda_initSEXP, SEXP sigma2_initSEXP, SEXP thinSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat >::type X(XSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type thin(thinSEXP);
    Rcpp::traits::input_parameter< int >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(Modified_PC_Gibbs(X, y, a1, b1, u1, v1, nsamples, lambda_init, sigma2_init, thin, verbose));
    return rcpp_result_gen;
END_RCPP
}
// MillsRatio
...
static const R_CallMethodDef CallEntries[] = {
    {"_BayesianLasso_Modified_Hans_Gibbs", (DL_FUNC) &_BayesianLasso_Modified_Hans_Gibbs, 14},
    {"_BayesianLasso_Modified_PC_Gibbs", (DL_FUNC) &_BayesianLasso_Modified_PC_Gibbs, 11},
