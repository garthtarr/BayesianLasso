...
Modified_Hans_Gibbs <- function(y, X, beta_init, a1 = 1, b1 = 1, u1 = 1, v1 = 1, nsamples = 100L, lambda_init = 0.5, sigma2_init = 1, thin = 1L, verbose = 100L, tune_lambda2 = TRUE, rao_blackwellization = FALSE) {
    .Call(`_BayesianLasso_Modified_Hans_Gibbs`, y, X, beta_init, a1, b1, u1, v1, nsamples, lambda_init, sigma2_init, thin, verbose, tune_lambda2, rao_blackwellization)
}
